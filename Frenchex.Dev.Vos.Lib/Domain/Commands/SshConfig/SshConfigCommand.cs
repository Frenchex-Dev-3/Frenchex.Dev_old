...
namespace Frenchex.Dev.Vos.Lib.Domain.Commands.SshConfig
{
    public class SshConfigCommand : RootCommand, ISshConfigCommand
    {
        ...
        private readonly Vagrant.Lib.Domain.Commands.SshConfig.ISshConfigCommandRequestBuilderFactory _vagrantSshConfigCommandRequestBuilderFactory;
        ...
        public SshConfigCommand(
            ...
            Vagrant.Lib.Domain.Commands.SshConfig.ISshConfigCommandRequestBuilderFactory vagrantSshConfigCommandRequestBuilder
