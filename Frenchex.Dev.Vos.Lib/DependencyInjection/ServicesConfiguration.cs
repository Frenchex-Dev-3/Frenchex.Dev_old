    ...
    public class ServicesConfiguration
    {
        public static IServiceCollection ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                // Bases
                .AddTransient<IMachineBaseDefinitionBuilder, MachineBaseDefinitionBuilder>()
                .AddTransient<IMachineBaseDefinitionBuilderFactory, MachineBaseDefinitionBuilderFactory>()

                .AddTransient<IMachineDefinitionBuilder, MachineDefinitionBuilder>()
                .AddTransient<IMachineDefinitionBuilderFactory, MachineDefinitionBuilderFactory>()
                ...
                .AddSingleton<IDefineMachineAddCommandResponseBuilderFactory, DefineMachineAddCommandResponseBuilderFactory>()
                ...
                .AddSingleton<IDefineMachineTypeAddCommandRequestBuilderFactory, DefineMachineTypeAddCommandRequestBuilderFactory>()
                .AddTransient<IDefineMachineTypeAddCommandResponseBuilder, DefineMachineTypeAddCommandResponseBuilder>()
                .AddSingleton<IDefineMachineTypeAddCommandResponseBuilderFactory, DefineMachineTypeAddCommandResponseBuilderFactory>()
